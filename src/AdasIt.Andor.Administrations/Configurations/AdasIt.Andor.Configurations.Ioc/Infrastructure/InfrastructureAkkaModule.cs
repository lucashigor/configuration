...
internal class InfrastructureAkkaModule(IConfiguration configuration) : IAkkaModule
{
    ...
    ");
        ...
        builder.WithActors((system, registry) =>
        {
            ...
            var supervisor = system.ActorOf(props, nameof(ConfigurationCommandsInfrastructureSupervisor));
        ...
        builder.WithActors((system, registry) =>
        {
            ...
            var supervisor = system.ActorOf(props, nameof(ConfigurationQueriesInfrastructureSupervisor));
