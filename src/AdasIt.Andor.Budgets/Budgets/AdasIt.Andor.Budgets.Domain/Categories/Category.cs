...
#pragma warning restore CS8618, CS9264
    ...
    private Category(Name name, Description description, DateTime startDate,
    ...
    public static async Task<(DomainResult, Category?)> NewAsync(Name name, Description description, DateTime startDate,
    ...
    public Task<DomainResult> SetSubCategory(List<SubCategory> subCategories)
    {
